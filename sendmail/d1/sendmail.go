...
func main() {
	...
	serverPort := 465
	fromEmail := "szops@dg-mall.com"
	fromPasswd := "RooijjG7A7TEoC9i1"

	myToers := "qujian@51-ddg.com, 1201172821@qq.com" // 逗号隔开
	myCCers := ""                                   //xxoo@163.com

	subject := "这是主题"
	body := `这是正文<br>
            <h3>这是标题</h3>
             Hello <a href = "https://io10.top">主页</a><br>`
	// 结构体赋值
	myEmail := &EmailParam{
